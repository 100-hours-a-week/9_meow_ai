...
def hamster_converter(text):
    ...
    # 단일 패턴 뒤의 찍 제거
    result = re.sub(r'(해보(바보)|소피|곤뇽|햄하|미스코리냥|#미스코리냥|찍찍|아하쮸|왕왕|어찌|이찌|화이찡|꾸앙|끄오|뀨악|햄잼|햄맛|햄맛탱|햄예|햄귀|햄좋|쮸|어떠햄|뀨앙|쮸우우|햄바|햄빠|햄찌들|햄이팅|미야옹즈|미야옹|햄하하)찍', r'\1', result)
